...
SECRET_KEY = 'django-insecure-9%2g3(@+3)^@-%np#0=#woevy@mbfqx+r@3-#)*l68d_z1xi-r'
...
CORS_ALLOWED_ORIGINS = [
    "http://localhost:4200",  # Port standard d'Angular en développement
    "http://localhost:59976",
]

# Si besoin selon tes requêtes
CORS_ALLOW_CREDENTIALS = True   # si tu envoies cookies ou auth
